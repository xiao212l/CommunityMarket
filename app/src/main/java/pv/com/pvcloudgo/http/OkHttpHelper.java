...
//        }
    ...
    public void Delete(String url,String Token, BaseCallback callback){
        Request.Builder builder = new Request.Builder()
                .url(url);
        builder.delete(new RequestBody() {
            @Override
    ...
    public void PostImage(String url, File file, String Token, BaseCallback callback){

        RequestBody body = new MultipartBuilder().type(MediaType.parse("multipart/form-data"))
                .addFormDataPart("file","heder.png",RequestBody.create(MediaType.parse("image/png"),file))
                .build();
...
public void Put(String url, String Token, BaseCallback callback){
    Request.Builder builder = new Request.Builder()
            .url(url);
